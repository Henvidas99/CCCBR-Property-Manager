  ...
  <div class="bg-gray-50 min-h-screen">
    ...
    <div v-if="error" class="flex items-center justify-center min-h-[60vh]">
      <div class="text-center">
        ...
        <NuxtLink to="/portfolio" class="text-[#202d59] hover:underline text-sm font-medium">← Volver al portafolio</NuxtLink>
      </div>
    </div>
    ...
    <div v-else-if="property" class="w-full px-4 sm:px-6 lg:px-8 py-6 max-w-5xl mx-auto">
      ...
      <!-- Back link -->
      <NuxtLink to="/portfolio" class="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-[#202d59] transition-colors mb-4">
