...
export const COSTA_RICA_PROVINCES: Province[] = [
  {
    ...
    cantons: [
      ...
      { name: 'Aserri', districts: ['Aserrí', 'Tarbaca', 'Vuelta de Jorco', 'San Gabriel', 'Legua', 'Monterrey', 'Salitrillos'] },
      ...
      { name: 'Vazquez de Coronado', districts: ['San Isidro', 'San Rafael', 'Dulce Nombre de Jesús', 'Patalillo', 'Cascajal'] },
      { name: 'Acosta', districts: ['San Ignacio', 'Guaitil', 'Palmichal', 'Cangrejal', 'Sabanillas'] },
      { name: 'Tibas', districts: ['San Juan', 'Cinco Esquinas', 'Anselmo Llorente', 'León XIII', 'Colima'] },
      ...
      { name: 'Perez Zeledon', districts: ['San Isidro de El General', 'El General', 'Daniel Flores', 'Rivas', 'San Pedro', 'Platanares', 'Pejibaye', 'Cajón', 'Barú', 'Río Nuevo', 'Páramo', 'La Amistad'] },
      { name: 'Leon Cortes Castro', districts: ['San Pablo', 'San Andrés', 'Llano Bonito', 'San Isidro', 'Santa Cruz', 'San Antonio'] },
    ],
  },
  {
    name: 'Alajuela',
    cantons: [
      ...
      { name: 'San Ramon', districts: ['San Ramón', 'Santiago', 'San Juan', 'Piedades Norte', 'Piedades Sur', 'San Rafael', 'San Isidro', 'Ángeles', 'Alfaro', 'Volio', 'Concepción', 'Zapotal', 'Peñas Blancas', 'San Lorenzo'] },
      ...
      { name: 'Naranjo', districts: ['Naranjo', 'San Miguel', 'La Palmera', 'Rosario', 'Palmitos', 'El Rosario', 'San Juan', 'Cirrí Norte', 'San Jerónimo', 'San José'] },
      { name: 'Palmares', districts: ['Palmares', 'Zaragoza', 'Buenos Aires', 'Santiago', 'Candelaria', 'Esquipulas', 'La Granja'] },
      { name: 'Poas', districts: ['San Juan', 'San Pedro', 'Carrillos', 'Sabana Redonda'] },
      ...
      { name: 'Sarchi', districts: ['Sarchí Norte', 'Sarchí Sur', 'Toro Amarillo', 'San Pedro', 'Rodríguez'] },
      ...
      { name: 'Rio Cuarto', districts: ['Río Cuarto', 'Santa Isabel'] },
    ],
  },
  {
    name: 'Cartago',
    cantons: [
      ...
      { name: 'Paraiso', districts: ['Paraíso', 'Santiago', 'Orosi', 'Cachí', 'Llanos de Santa Lucía'] },
      { name: 'La Union', districts: ['Tres Ríos', 'San Diego', 'San Juan', 'San Rafael', 'Concepción', 'Dulce Nombre', 'San Ramón', 'Río Azul'] },
      { name: 'Jimenez', districts: ['Juan Viñas', 'Tucurrique', 'Pejibaye'] },
  ...
  },
  {
    ...
    cantons: [
      ...
      { name: 'Santa Barbara', districts: ['Santa Bárbara', 'San Pedro', 'San Juan', 'Jesús', 'Santo Domingo', 'Puraba'] },
      ...
      { name: 'Belen', districts: ['San Antonio', 'La Ribera', 'La Asunción'] },
      { name: 'Flores', districts: ['San Joaquín', 'Barrantes', 'Llorente'] },
      { name: 'San Pablo', districts: ['San Pablo', 'Rincón de Sabanilla'] },
      { name: 'Sarapiqui', districts: ['Puerto Viejo', 'La Virgen', 'Las Horquetas', 'Llanuras del Gaspar', 'Cureña'] },
    ],
  },
  {
    name: 'Guanacaste',
    cantons: [
      ...
      { name: 'Canas', districts: ['Cañas', 'Palmira', 'San Miguel', 'Bebedero', 'Porozal'] },
      { name: 'Abangares', districts: ['Las Juntas', 'Sierra', 'San Juan', 'Colorado'] },
      { name: 'Tilaran', districts: ['Tilarán', 'Quebrada Grande', 'Tronadora', 'Santa Rosa', 'Líbano', 'Tierras Morenas', 'Arenal', 'Cabeceras'] },
  ...
  },
  {
    name: 'Puntarenas',
    cantons: [
      { name: 'Puntarenas', districts: ['Puntarenas', 'El Roble', 'Arancibia', 'Barranca', 'Monte Verde', 'Isla del Coco', 'Chacarita', 'Chomes', 'Lepanto', 'Paquera', 'Manzanillo', 'Guacimal', 'Bajos de Oros', 'Esterillos Oeste', 'Esterillos Centro', 'Esterillos Este', 'Cóbano'] },
      ...
      { name: 'Corredores', districts: ['Corredores', 'La Cuesta', 'Canoas', 'Laurel'] },
  ...
  },
  {
    ...
    cantons: [
      ...
      { name: 'Pococi', districts: ['Guápiles', 'Jiménez', 'Rita', 'Roxana', 'Cariari', 'Colorado', 'La Colonia'] },
      ...
      { name: 'Guacimo', districts: ['Guácimo', 'Mercedes', 'Pocora', 'Río Jiménez', 'Duacarí'] },
    ],
  },
]
...
export const getDistrictsByProvinceCanton = (provinceName: string, cantonName: string): string[] => {
  const province = COSTA_RICA_PROVINCES.find((p) => p.name === provinceName)
  if (!province) return []
